...
import { Button, SafeAreaView, ScrollView, StatusBar, Text, View, useColorScheme } from "react-native";
...
export function DemoScreen(): JSX.Element {
  ...
  const testEncrypt = async () => {
    ...
    const other = "024368ce46b89ec6b5e8c48357474b2a8e26594d00cd59ff14753f8f0051706016";
  ...
  return (
    <SafeAreaView style={backgroundStyle}>
      ...
      <ScrollView contentInsetAdjustmentBehavior="automatic">
        ...
        >
          <Text style={{ color: Colors.black, fontSize: 24 }}>expo-demo Mobile Dapp Test</Text>
          <Button title="TestEncrypt" onPress={testEncrypt} />
          <Text style={{ color: Colors.black }}>{encryptionTime && `Encryption time: ${encryptionTime} ms`}</Text>
          <DAPPView />
        </View>
      </ScrollView>
    </SafeAreaView>
