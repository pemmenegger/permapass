...
const WithSDKConfig = ({ children }: { children: React.ReactNode }) => {
  const { socketServer, infuraAPIKey, useDeeplink, debug, checkInstallationImmediately } = useSDKConfig();
    ...
    <MetaMaskProvider
      ...
      sdkOptions={{
        ...
        storage: {
          enabled: true,
          debug,
          storageManager: new StorageManagerRN({ debug, enabled: true }),
        },
        dappMetadata: {
          name: "expo-demo",
        },
...
export default function App() {
  ...
  const INFURA_API_KEY = "2Nxca4S9yIKHNyPZ0JetWFvHyO6";
